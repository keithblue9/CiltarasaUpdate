    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-[55] flex items-center gap-2 pl-3 pr-4 h-12 rounded-full bg-gradient-to-br from-[#7C2D12] to-[#B45309] text-white shadow-lg hover:scale-105 transition-transform"
        >
          <Sparkles size={20} />
      ...
      {open && (
        <div className="fixed z-[55] inset-x-0 bottom-0 h-[100dvh] sm:inset-x-auto sm:left-auto sm:right-5 sm:bottom-5 sm:w-[400px] sm:h-[600px] sm:max-h-[88vh] bg-[#FFFBF5] sm:rounded-3xl shadow-2xl sm:border border-[#FED7AA] flex flex-col overflow-hidden">
          <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-[#7C2D12] to-[#B45309] text-white">
